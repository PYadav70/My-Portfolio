...
const Navbar = ({isDarkMode, setIsDarkMode}) => {
  ...
  return (
    ...
    <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 ${isScroll ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm dark:bg-darkTheme dark:shadow-white/20" : ""}`}>
        <a href="#top">
            <Image src={isDarkMode ? assets.my_dark_logo : assets.my_logo} alt='' className='w-28 cursor-pointer mr-14'></Image>
        </a>
        <ul className={`hidden md:flex items-center gap-6 lg:gap-8 rounded-full px-12 py-3 ${isScroll ? "" : " bg-white shadow-sm bg-opacity-50 dark:border dark:border-white/50 dark:bg-transparent "}`}>
            <li><a className='font-Ovo' href="#top">Home</a></li>
            <li><a className='font-Ovo' href="#about">About Me</a></li>
            {/* <li><a className='font-Ovo' href="#services">Service</a></li> */}
            <li><a className='font-Ovo' href="#work">My Project</a></li>
        ...
        <div className='flex items-center gap-4'>
            ...
            <a className='hidden lg:flex items-center gap-3 px-10
             py-2.5 border border-gray-500 rounded-full ml-4 font-Ovo dark:border-white/50' href="#contact">Contact
