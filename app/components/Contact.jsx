...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
      ...
      formData.append("access_key", "46f13b4a-26b4-4513-9152-f30d64bb3785");
        ...
        <motion.form
         ...
         onSubmit={onSubmit} className='max-w-2xl mx-auto'>
            ...
            className='py-3 px-8 w-max flex items-center justify-between gap-2 bg-black/80 text-white rounded-full mx-auto
             hover:bg-black duration-500 dark:bg-transparent dark:border-[0.5px] dark:hover:bg-darkHover ' type='submit'>Submit now <Image src={assets.right_arrow_white} className='w-4' alt=''/></motion.button>
